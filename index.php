...
<head>
  ...
  <title>volume of right triangular prism
</head>
  ...
  <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
      <div class="mdl-layout__header-row">
        <span class="mdl-layout-title">volume of right triangular prism
      </div>
    </header>
    <main class="mdl-layout__content">
      <div class="right-image">
        <img src="./images/volume_of_right_triangular_prism.png" alt="street" />
      </div>
      <div class="page-content-php">Enter the base, height and length in cm.
        <form action="answer.php" method="GET">
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="base-of-right-triangular-prism">
            <label class="mdl-textfield__label" for="base-of-right-triangular-prism">Base of right triangular prism (cm)</label>
            <span class="mdl-textfield__error">Input is not a number!</span>
          </div>
          <br />
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="height-of-right-triangular-prism">
            <label class="mdl-textfield__label" for="height-of-right-triangular-prism">Height of right triangular prism (cm)</label>
            <span class="mdl-textfield__error">Input is not a number!</span>
          </div>
          <br />
          <div class="mdl-textfield mdl-js-textfield">
            <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="length-of-right-triangular-prism">
